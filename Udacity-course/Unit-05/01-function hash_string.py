'''Module for the function hash_string.'''
def hash_string(keyword, buckets):#This function it was generated by me.
...
#The function version of the course:
...
def test_hash_function(func, keys, size):#This function it was copied from the course, it's not mine.
    ...
    for w in keys:
        if w not in keys_used:
            ...
            keys_used.append(w)
    return results
print(test_hash_function(hash_string, 'udacity', 12))#Output the bucket number where each of the characters of the string are located.
...
print(test_hash_function(hash_string, chr(proof_s1), 12))#Output the bucket number where the string/ keyword 'udacity' is located.
