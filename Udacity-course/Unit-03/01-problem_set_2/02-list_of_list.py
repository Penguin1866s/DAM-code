...
def calc_fees( num_students , fees):
    return num_students * fees

def total_enrollment(list_of_list):
    total_fees = 0
    total_students = 0
    for element in list_of_list:
        total_fees = total_fees + calc_fees(element[1] , element[2])
        total_students = total_students + element[1]
